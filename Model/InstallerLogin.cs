...
namespace FingerCrew.Model
{
    public class InstallerLogin
    {
        ...
        public OResponse loginInstaller(loginInstallerMDetails param)
        {
            ...
            {
                CommonUtilities.FnStoreErrorLog("FingerCrewAPI", "loginInstaller", ex.Message, ex.StackTrace);
                oresponse.status = "Failed";
    ...
    //}
    public class loginInstallerMDetails
    {
