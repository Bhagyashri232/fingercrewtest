...
namespace FingerCrew.Model
{
    public class ResendOTP
    {
        ...
        public OResponse resend(resendOTPMDetails param)
        {
            ...
            {
                CommonUtilities.FnStoreErrorLog("FingerCrewAPI", "resend", ex.Message, ex.StackTrace);
                oresponse.status = "Failed";
    ...
    //}
    public class resendOTPMDetails
    {
